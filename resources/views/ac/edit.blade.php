...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <!-- Header -->
            <div class="mb-4">
                <h3 class="mb-3">Update Air Conditioner</h3>
                <a href="/tugascrud">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    @foreach($airconditioner as $k)
                    <form action="/tugascrud/update" method="POST" id="acForm">
                        @csrf
                        <input type="hidden" name="id" value="{{ $k->ID }}">

                        <!-- Merk Field -->
                        <div class="mb-3">
                            <label for="merkairconditioner" class="form-label fw-semibold">
                                Merk Air Conditioner <span class="text-danger">*</span>
                            </label>
                            <input type="text"
                                   class="form-control @error('merkairconditioner') is-invalid @enderror"
                                   id="merk"
                                   name="merk"
                                   value="{{ old('merkairconditioner', $k->merkairconditioner) }}"
                                   placeholder="Contoh: Panasonic, Sharp, Miyako"
                                   required>
                            @error('merkairconditioner')
                        ...
                        <div class="mb-3">
                            <label for="harga" class="form-label fw-semibold">
                                Harga Air Conditioner <span class="text-danger">*</span>
                            </label>
                            <div class="input-group">
                                ...
                                <input type="number"
                                       ...
                                       id="harga"
                                       name="harga"
                                       value="{{ old('harga', $k->hargaairconditioner) }}"
                                       placeholder="150000"
                                       min="0"
                                       step="1000"
                                       required>
